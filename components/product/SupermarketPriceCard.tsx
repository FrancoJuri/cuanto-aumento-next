...
const SupermarketPriceCard = ({
  ...
  return (
    <div className="w-full flex items-stretch gap-2">
      <button
        onClick={onClick}
        className="flex-1 flex items-center gap-4 p-4 rounded-xl border border-gray-100 hover:border-gray-200 hover:bg-gray-50/50 transition-all duration-200 text-left group cursor-pointer"
      >
        {/* Location Icon */}
